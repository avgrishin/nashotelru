...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        LicenseName = Request.ServerVariables["HTTP_HOST"];
        LicenseKey = string.Format("2{0}11EFGH1JK11NOPQRSTUVWXY81", "ZYXWVUTSRQPNMLKJHGFEDCBA987654321"[LicenseName.Length % 33 + (int)LicenseName.Length / 33]);
        //LicenseKey = "2J11EFGH1JK11NOPQRSTUVWXY81";
